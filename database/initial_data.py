...
def initialize_database(db: Session):
    ...
    # --- ШАГ 3: Создаем клиентов и сотрудников с новыми полями ---
    ...
    staff_tech = crud.create_staff(db, staff_tech_data) # <--- Создаем его
    print("Клиенты и сотрудники созданы.")

    # --- ШАГ 4: Создаем пользователей ---
    users_to_create = [
        ...
        {"username": "tech_admin", "password": "tech123", "role": "tech_admin", "staff_id": staff_tech.id}, # <--- ДОБАВЛЕНО
